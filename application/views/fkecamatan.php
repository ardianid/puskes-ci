...
/* } */
  ...
  <div class="container">
   ...
   <!-- <h3>Data Pasien</h3> -->
    <br />
    <button id="btaddpasien" class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Kecamatan</button>
    <br />
    <br />
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('kecamatan_ctrl/ajax_list')?>",
            "type": "POST"
        },
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('kecamatan_ctrl/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
 
            $('[name="id"]').val(data.kd_kec);
            $('[name="tnama_kecamatan"]').val(data.nama_kec);
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('kecamatan_ctrl/ajax_add')?>";
      }
      else
      {
        url = "<?php echo site_url('kecamatan_ctrl/ajax_update')?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Yakin akan dihapus?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('kecamatan_ctrl/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {

...
$(document).ready(function() {
  ...
  table_pencarian = $('#table_cari').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('posyandu_ctrl/ajax_list_pencarian')?>",
            "type": "POST",
            "data": function(d) {
              d.nama_posyandu= $('#tnama_pos_cr').val();
              d.alamat_posyandu= $('#alamat_pos_cr').val();
              d.nama_desa= $('#desa_cr').val();
...
function kosongkan_data(){
  ...
  $('[name="tid_posyandu"]').val('');

  $('[name="tnama_posyandu"]').val('');
  $('[name="talamat_posyandu"]').val('');
  $('[name="tjenis_posyandu"]').val('');
  $('[name="trt"]').val('');
  $('[name="trw"]').val('');
  $('[name="tjml_kader"]').val('0');
  $('[name="tkd_desa"]').val('');
  $('[name="tnama_desa"]').val('');
  $('[name="tnama_kel"]').val('');
  $('[name="tnama_kec"]').val('');
...
function edit_ins(id)
{
  ...
  $.ajax({
        url : "<?php echo site_url('posyandu_ctrl/ajax_get_by_id_pencarian')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

      $('[name="tid_posyandu"]').val(data.id_posyandu);

      $('[name="tnama_posyandu"]').val(data.nama_posyandu);
      $('[name="talamat_posyandu"]').val(data.alamat_posyandu);
      $('[name="tjenis_posyandu"]').val(data.jenis_posyandu);
      $('[name="trt"]').val(data.rt);
      $('[name="trw"]').val(data.rw);
      ...
      $('[name="tjml_kader"]').val(data.jml_kader);
...
function delete_ins(id)
    {
      if(confirm('Yakin akan dihapus?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('posyandu_ctrl/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('posyandu_ctrl/ajax_add')?>";
      }
      else
      {
        url = "<?php echo site_url('posyandu_ctrl/ajax_update')?>";
      }
       ...
       // ajax adding data to database
          $.ajax({
            ...
            type: "POST",
            data: {
              "nama_posyandu": $("#tnama_posyandu").val(),
              "alamat_posyandu": $("#talamat_posyandu").val(),
              "jenis_posyandu": $("#tjenis_posyandu").val(),
              "kd_desa": $("#tkd_desa").val(),
              "rt": $("#trt").val(),
              "rw": $("#trw").val(),
              "jml_kader": $("#tjml_kader").val(),
              "kd_puskes": $("#tkd_puskes").val(),
              "id_posyandu": $("#tid_posyandu").val(),
            } ,
            dataType: "JSON",
            success: function(data)
            {
      ...
      <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li class="active"><a id="tab_diagnosa2" href="#tab_diagnosa" data-toggle="tab">Data Posyandu</a></li>
            ...
            <div class="alert alert-warning">
              ...
              <tr>
                <td width="15%">Nama Posyandu</td>
                <td width="1%">:</td>
                <td width="25%">
                  <input type="text" class="form-control input-sm" name="tnama_pos_cr" id="tnama_pos_cr" >
                </td>
                <td width="7%">&nbsp;</td>
                <td width="10%">Desa</td>
                <td width="1%">:</td>
                <td width="43%">
                  <input type="text" class="form-control input-sm" name="desa_cr" id="desa_cr" >
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>:</td>
                <td>
                  <input type="text" class="form-control input-sm" name="alamat_pos_cr" id="alamat_pos_cr" >
                </td>
                <td>&nbsp;</td>
                <td></td>
                <td></td>
       ...
       <div class="tab-pane fade" id="tab_detail">
            ...
            <input type="hidden" name="tid_posyandu" id="tid_posyandu" >
          ...
          <!--  <div class="alert alert-warning"> -->
            ...
            <tr>
              <td width="17%">Nama Posyandu</td>
              <td width="1%">:</td>
              <td width="82%">
                <input type="text" class="form-control input-sm" id="tnama_posyandu" name="tnama_posyandu">
              </td>
            </tr>
            <tr>
              ...
              <td>:</td>
              <td>
                <input type="text" class="form-control input-sm" id="talamat_posyandu" name="talamat_posyandu">
              </td>
            </tr>
            <tr>
              <td>RT</td>
              <td>:</td>
              <td>
                <input type="text" class="form-control input-sm" id="trt" name="trt">
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>:</td>
              <td>
                <input type="text" class="form-control input-sm" id="trw" name="trw">
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>:</td>
              <td>
                <select name="tjenis_posyandu" id="tjenis_posyandu" class="form-control input-sm">
            ...
            <tr>
              ...
              <td>:</td>
              <td>
                <input type="text" class="form-control input-sm size_kecil" id="tjml_kader" name="tjml_kader">
              </td>
            </tr>

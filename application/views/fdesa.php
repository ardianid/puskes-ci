...
<html>
  ...
  <div class="container">
   <!-- <h3>Data Pasien</h3> -->
    <br />
    <button id="btaddpasien" class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add-Desa</button>
    <br />
    <br />
  ...
  <script src="<?=base_url();?>asset/js/bootstrap-datepicker.min.js"></script>
    ...
    /* nama pasien rawat jalan */
      $("#tnama_kel").autocomplete({  
                minLength: 1,  
                source:   
                function(req, add){  
                    $.ajax({  
                        url: "desa_ctrl/lookup_kelurahan",  
                        dataType: 'json',  
                        type: 'POST',  
                        data: req,  
                        success:      
            ...
            select:   
                function(event, ui) {  
                    ...
                    $("#tnama_kel").val( ui.item.value );
                    $("#tnama_kec").val(ui.item.desc);
      ...
      table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('desa_ctrl/ajax_list')?>",
            "type": "POST"
        },
    ...
    function add_person()
    {
      ...
      $('.modal-title').text('Add Desa'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('desa_ctrl/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit Desa'); // Set title to Bootstrap modal title
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('desa_ctrl/ajax_add')?>";
      }
      else
      {
        url = "<?php echo site_url('desa_ctrl/ajax_update')?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Yakin akan dihapus?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('desa_ctrl/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-content">
      ...
      <div class="modal-body form bg-warning">
        <form action="#" id="form" class="form-horizontal">
           ...
           <input type="hidden" value="" name="tkd_desa" id="tkd_desa" />
           <input type="hidden" value="" name="tkd_kel"  id="tkd_kel" />
          ...
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="tnama_kel" id="tnama_kel" placeholder="Kelurahan" class="form-control input-sm" type="text">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="tnama_kec" id="tnama_kec" placeholder="Kecamatan" class="form-control input-sm" type="text" readonly='true'>
                <span class="help-block"></span>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="tnama_desa" id="tnama_desa" placeholder="Desa" class="form-control input-sm" type="text">
                <span class="help-block"></span>
              </div>
            </div>

...
<style type="text/css">
  ...
  <div class="container">
   ...
   <!-- <h3>Data Pasien</h3> -->
    <br />
    <button id="btaddpasien" class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Petugas</button>
    <br />
    <br />
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('petugas_ctrl/ajax_list')?>",
            "type": "POST"
        },
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('petugas_ctrl/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="id"]').val(data.id);
            $('[name="tkode"]').val(data.kd_petugas);
            $('[name="tnama"]').val(data.nama_petugas);
            $('[name="tposisi"]').val(data.posisi);
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('petugas_ctrl/ajax_add')?>";
      }
      else
      {
        url = "<?php echo site_url('petugas_ctrl/ajax_update')?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Yakin akan dihapus?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('petugas_ctrl/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input id="tkode" name="tkode" placeholder="Kode Petugas" class="form-control" type="text">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="tnama" placeholder="Nama Petugas" class="form-control" type="text">
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <select name="tposisi" class="form-control">
                  <option value="DOKTER">DOKTER</option>
                  <option value="PERAWAT">PERAWAT</option>
                  <option value="BIDAN">BIDAN</option>
                  <option value="APOTEKER">APOTEKER</option>
                  <option value="ASS APOTEKER">ASS APOTEKER</option>

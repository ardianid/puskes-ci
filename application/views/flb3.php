...
<h3 class="text-primary"><strong>LAPORAN  </strong><small><strong>LB-3</strong></small></h3>
<hr>

<div class="alert alert-warning">
<form action="lap_lb3_ctrl/ajax_export_excel" method="post" enctype="multipart/form-data">

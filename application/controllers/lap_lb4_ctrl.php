...
class lap_lb4_ctrl extends CI_Controller {

public function __construct()
    {
        parent::__construct();
        $this->load->model('mdl_lap_lb4','mdl_lap_lb4');
    }
...
public function ajax_export_excel(){
    ...
    $this->mdl_lap_lb4->export_excel($bln,$thn,$kd_puskes);

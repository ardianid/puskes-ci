...
class lap_lb3_ctrl extends CI_Controller {

public function __construct()
    {
        parent::__construct();
        $this->load->model('mdl_lap_lb3','mdl_lap_lb3');
    }
...
public function ajax_export_excel(){
    ...
    $this->mdl_lap_lb3->export_excel($bln,$thn,$kd_puskes);
